...
async def play(ctx, url=None):
    ...
    if not voice_client or not voice_client.is_connected():
        try:
            ...
            return await ctx.send('Wystąpił błąd podczas dołączania do kanału głosowego.')
    ...
    with youtube_dl.YoutubeDL(ydl_opts) as ydl:
        ...
        voice_client.play(discord.FFmpegPCMAudio(music_url), after=lambda e: print('Odtwarzanie zakończone'))

    await ctx.send('Odtwarzam muzykę!')  # Możesz dostosować komunikat potwierdzający odtwarzanie muzyki
